    ...
    fProxyIpValid(true)
{
    ...
    ui->unit->setModel(new FluxUnits(this));
...
void OptionsDialog::setMapper()
{
    ...
    mapper->addMapping(ui->fluxAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::showRestartWarning_Proxy()
{
    ...
    {
        QMessageBox::warning(this, tr("Warning"), tr("This setting will take effect after restarting Flux."), QMessageBox::Ok);
