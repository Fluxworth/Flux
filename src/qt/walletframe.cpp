...
WalletFrame::WalletFrame(FluxGUI *_gui) :
    QFrame(_gui),
    gui(_gui),
    clientModel(0)
{
...
void WalletFrame::gotoReceiveFluxPage()
{
    walletStack->gotoReceiveFluxPage();
}

void WalletFrame::gotoSendFluxPage(QString addr)
{
    walletStack->gotoSendFluxPage(addr);
}
...
void WalletFrame::gotoBlockExplorer()
{
    walletStack->gotoBlockExplorer();
}

void WalletFrame::gotoStatistics()
{
    walletStack->gotoStatistics();
}
