...
contains(flux_NEED_QT_PLUGINS, 1) {
    DEFINES += flux_NEED_QT_PLUGINS
...
HEADERS += src/qt/fluxgui.h \
    src/qt/transactiontablemodel.h \
    src/qt/addresstablemodel.h \
    src/qt/optionsdialog.h \
    src/qt/sendfluxdialog.h \
...
SOURCES += src/qt/flux.cpp \
    src/qt/fluxgui.cpp \
    src/qt/transactiontablemodel.cpp \
    src/qt/addresstablemodel.cpp \
    src/qt/optionsdialog.cpp \
    src/qt/sendfluxdialog.cpp \
    ...
    src/qt/fluxaddressvalidator.cpp \
    src/alert.cpp \
    src/version.cpp \
    src/sync.cpp \
    src/util.cpp \
    ...
    src/qt/fluxstrings.cpp \
    src/qt/fluxamountfield.cpp \
    src/wallet.cpp \
    src/keystore.cpp \
    ...
    src/crypter.cpp \
    src/qt/sendfluxentry.cpp \
    src/qt/qvalidatedlineedit.cpp \
    src/qt/fluxunits.cpp \
...
RESOURCES += src/qt/flux.qrc

FORMS += src/qt/forms/sendfluxdialog.ui \
...
# also add new translations to src/qt/flux.qrc under translations/
TRANSLATIONS = $$files(src/qt/locale/flux_*.ts)
...
win32:RC_FILE = src/qt/res/flux-qt.rc
...
macx:ICON = src/qt/res/icons/flux.icns
